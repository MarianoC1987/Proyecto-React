...

{
    ...
    descripcion:'It can reconstitute its entire cellular structure to change into what it sees, but returns to normal when it relaxes.',
estadisticas:{
HP:48,
ATK:48,
DEF:48,
...

{
    ...
    descripcion:'When viewed through a microscope, this Pokémon short, fine, delicate hair can be seen.',
estadisticas:{
HP:100,
ATK:100,
DEF:100,
...

{
    ...
    descripcion:'It eats iron are - and sometimes railroad tracks - to build up the steel armor that protects its body.',
estadisticas:{
HP:50,
ATK:70,
DEF:100,
