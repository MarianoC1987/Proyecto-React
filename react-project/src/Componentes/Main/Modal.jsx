      ...
      {poke && (
        <>
          ...
          >
            ...
            >
              {pokemons[index - 1] ? (
                <Link to={`/modal/${pokemons[index - 1].id}`}>
                  <Image
                    h="10%"
                ...
                <Link to={`/modal/${pokemons[pokemons.length - 1].id}`}>
                  <Image
                    h="10%"
                    src="/Imagenes/arrow-24-16.png"
                    transform="rotate(180deg)"
            ...
            >
              ...
              >
                ...
                <GridItem
                  ...
                  alignItems="center"
                >
                  <Text fontSize="small">{poke.movimientos[0]}</Text>
                  <Text fontSize="small">{poke.movimientos[1]}</Text>
                </GridItem>
                <GridItem
                  borderRight="1px"
                  borderColor="gray.300"
